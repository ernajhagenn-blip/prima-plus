...
export default async function GamePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div className="relative mb-6 overflow-hidden rounded-3xl border-2 border-purple-200 bg-white/70 p-6 shadow-lg backdrop-blur-md">
        <div className="absolute left-0 top-0 h-full w-1.5 rounded-l-3xl bg-gradient-to-b from-purple-400 to-fuchsia-500" />
        <span className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-purple-400 to-fuchsia-500 px-3 py-1 text-xs font-black text-white shadow-md">
          ⚔️ TAHAP 2 / 4
        </span>
      ...
      <div className="relative overflow-hidden rounded-3xl border-2 border-purple-200 bg-white/70 p-6 shadow-lg backdrop-blur-md">
        <div className="absolute left-0 top-0 h-full w-1.5 rounded-l-3xl bg-gradient-to-b from-purple-400 to-fuchsia-500" />

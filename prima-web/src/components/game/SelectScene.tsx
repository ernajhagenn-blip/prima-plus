...
export default function SelectScene({ config }: { config: HeroConfig }) {
  return (
    <Canvas shadows camera={{ position: [0, 2, 7], fov: 40 }}>
      ...
      <mesh position={[0, -1.55, 0]}><cylinderGeometry args={[2.6, 2.9, 0.5, 32]} /><meshStandardMaterial color="#334155" /></mesh>
      <mesh position={[0, -1.25, 0]}><cylinderGeometry args={[2.4, 2.4, 0.1, 32]} /><meshStandardMaterial color="#facc15" /></mesh>

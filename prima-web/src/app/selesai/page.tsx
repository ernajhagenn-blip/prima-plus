...
export default async function SelesaiPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div className="relative overflow-hidden rounded-3xl border-2 border-green-200 bg-white/70 p-8 text-center shadow-lg backdrop-blur-md">
        ...
        <div className="mx-auto mt-6 max-w-sm space-y-2 rounded-2xl bg-white/60 p-4 text-left text-sm backdrop-blur-sm border border-green-100">
          ...
          <div className="flex items-center justify-between rounded-xl bg-purple-50 px-3 py-2">
            <span className="text-gray-600">⚔️ Kuis PRIMA+</span>

      ...
      <div className="flex min-h-dvh flex-col items-center justify-center bg-[#060b1e] px-4 text-white">
        ...
        >
          ...
          <motion.button
            ...
            className="mt-8 w-full rounded-2xl bg-gradient-to-r from-violet-500 to-purple-600 py-4 text-lg font-black text-white shadow-lg shadow-violet-500/20"
          >
            MULAI ▶
          </motion.button>
          <button
        ...
        >
          ...
          <div className="mt-6 flex gap-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => router.push("/games")}
              className="flex-1 rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 py-3 text-sm font-bold text-white"
            >
              ke Arcade →
            </motion.button>
          </div>

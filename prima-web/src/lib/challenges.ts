...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    type: "IDENTITY",
    level: 5,
    q: "Seorang teman berkata: 'Kalau aku pakai bahasa Indonesia terus, apa aku bakal dianggap kuno? Tapi kalau terus campur-campur, apa aku bakal lupa identitas budayaku sendiri?' Pertanyaan ini bikin berhenti sebentar — dan paling dekat dengan jawaban yang jujur adalah...",
    opts: [

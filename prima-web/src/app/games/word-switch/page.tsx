      ...
      <div className="flex min-h-dvh flex-col items-center justify-center bg-[#060b1e] px-4 text-white">
        ...
        >
          ...
          <motion.button
            ...
            className="mt-8 w-full rounded-2xl bg-gradient-to-r from-amber-500 to-orange-600 py-4 text-lg font-black text-white shadow-lg shadow-amber-500/20"
          >
            MULAI ▶
          </motion.button>
          <button
    ...
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center bg-[#060b1e] px-4 text-white">
        ...
        >
          ...
          <p className="mt-2 text-sm text-white/40">Word Switch</p>
          ...
          <div className="mt-6 flex gap-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => router.push("/games")}
              className="flex-1 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 py-3 text-sm font-bold text-white"
            >
              ke Arcade →
            </motion.button>
          </div>
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#060b1e] text-white">
      <div className="flex items-center justify-between px-4 pt-4 pb-2">
        ...
        <div className="rounded-lg bg-white/5 px-3 py-1.5 text-xs font-bold text-amber-400">
          {xp} XP
        </div>
      </div>
